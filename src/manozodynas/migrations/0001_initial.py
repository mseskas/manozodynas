...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Words'
        db.create_table(u'manozodynas_words', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('pronunciation', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'manozodynas', ['Words'])

        # Adding model 'Translation'
        db.create_table(u'manozodynas_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key_word', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('matches', self.gf('django.db.models.fields.CharField')(max_length=300)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'manozodynas_words')
    ...
    models = {
        ...
        u'manozodynas.translation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_word': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'matches': ('django.db.models.fields.CharField', [], {'max_length': '300'})
        },
        u'manozodynas.user': {
        ...
        u'manozodynas.words': {
            ...
            'pronunciation': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        }
    }
